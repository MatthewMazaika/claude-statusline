...
| `$1.23` | `cost.total_cost_usd` | Cost of the current conversation, to the cent. Resets to zero after each `/clear`. Hidden until the first billed turn. Windows only — the bash script omits this field. |
